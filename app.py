...
if st.session_state.screen == "bootstrap":
    ...
    render_admin_panel(
        db_connection,
        {
            ...
            "render_ranking": render_ranking,
            "reset_student_pin": reset_student_pin,
            "send_mail": send_mail,
            "set_announcement_active": set_announcement_active,
            "setting_get": setting_get,
            "setting_set": setting_set,
            "student_learning_detail": student_learning_detail,
            "student_question_rows": student_question_rows,
            "student_rows": student_rows,
            "taipei_time_text": taipei_time_text,
            "toggle_admin_progress_chapter": toggle_admin_progress_chapter,
            "update_and_activate_announcement": update_and_activate_announcement,
            "update_student_real_name": update_student_real_name,
            "validate_hero_name": validate_hero_name,
        },
    )
